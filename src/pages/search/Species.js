...
const Search = () => {
    ...
    return (
        <div className="main">
            <Header active="search/species" />
            <div id="page-header" className="species">
                <div className="eea banner">
                    <div className="image">
                        <div className="gradient">
                            <div className="ui container">
                                <div className="content">
                                    <h1 className="documentFirstHeading title">Search by Species</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <main>
                    <div id="view">
                        <div id="page-document" className="ui container">
                            <div className="ui form search species">
                                <div className={"page-description " + showDescription}>
                                    <p>
                                        Retrieve a species data from a given release.
                                    </p>
                                    <p>
                                    ...
                                    <p>
                                        Use the filter to select one or many species from the release.
                                    </p>
                                    <p>
                                        Results are presented as “cards”, that let you see the sites where the species appear. The whole results can also be download as a table.
                                    </p>
                                    {showDescription !== "all" &&
                                ...
                                <Accordion>
                                    ...
                                    <AccordionContent active={active.includes(0)}>
                                        ...
                                        <div className="field" id="field_types">
                                            <label htmlFor="field_types">Species groups</label>
                                            <div className="ui grid">
                                                {
                                                    ConfigData.SpeciesGroups.map((item, i) =>
                                                        ...
                                                        <div className="card-body">
                                                            ...
                                                            <div className="card-counters">
                                                                <div className="card-counter">
                                                                    <div className="card-number">{item.SpeciesCode}</div>
                                                                    <div className="card-value">Species code</div>
                                                                </div>
                                                            </div>
